...
public class CertificateDePresence {
    ...
    public static ByteArrayOutputStream createDoc(Enregistrement enr, Signataire signataire, boolean entete) {
        ...
        try {
            ...
            title = new Phrase();
            titleChunk = new Chunk("Attéstation de présence", fontTitle);
            ...
            // NumInscription
            attrib = new Phrase();
            attribChunk = new Chunk("Numéro d'inscription: ", fontAttrib);
            attrib.add(attribChunk);
            tc.addCell(attrib);
            text = new Phrase();
            textChunk = new Chunk(inscription.getNumeroInscription(), fontText);
            text.add(textChunk);
            tc.addCell(text);
